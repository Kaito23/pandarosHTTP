package de.koetter.robin.simple.webserver.awt;
...
public class MyTrayIcon {
	...
	private static void createAndShowGUI() {
		...
		final TrayIcon trayIcon = new TrayIcon(createImage("../images/url.png", "tray icon"));
		final SystemTray tray = SystemTray.getSystemTray();

		// Create a popup menu components
		final MenuItem aboutItem = new MenuItem("About");
		final CheckboxMenuItem cb1 = new CheckboxMenuItem("Set auto size");
		final CheckboxMenuItem cb2 = new CheckboxMenuItem("Set tooltip");
		...
		cb1.addItemListener(new ItemListener() {
			public void itemStateChanged(final ItemEvent e) {
				final int cb1Id = e.getStateChange();
		...
		cb2.addItemListener(new ItemListener() {
			public void itemStateChanged(final ItemEvent e) {
				final int cb2Id = e.getStateChange();
	...
	protected static Image createImage(final String path, final String description) {
		final URL imageURL = MyTrayIcon.class.getResource(path);
